      ...
      >
        ...
        <View className="flex flex-row items-center justify-between">
          <Pressable
            ...
            className="bg-Blue w-[48%] px-5 py-3 rounded-md flex flex-col items-center justify-center"
          >
      ...
      {selectingMap ? (
        <View className="flex-1 h-full">
          ...
          <View className="flex flex-row items-center justify-between px-5 pb-5 bg-White">
            ...
            <Pressable
              ...
              className="w-[48%] px-5 py-3 rounded-md bg-Blue flex flex-row items-center justify-center"
            >
              <Text className="text-White font-semibold text-[16px]">
                {i18n.t('plots.offlineMapsScreen.cancel')}
              </Text>
            ...
            <Pressable
              ...
              className="flex flex-row items-center justify-center w-[48%] px-5 py-3 rounded-md bg-Blue"
            >
        ...
        <View className="m-5">
          <Pressable
            ...
            className={cn(
              isConnected ? 'bg-Blue' : 'bg-Blue/50',
                  ...
                  >
                    <View className="flex flex-row items-center justify-center">
                      ...
                      pack?.percentage === 100 ? (
                        ...
                        <View className="w-[24] h-[24] p-[2px] bg-Blue rounded-full flex items-center justify-center">
